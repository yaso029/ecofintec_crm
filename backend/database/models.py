...
class User(Base):
    ...
    role = Column(String(30), nullable=False, default="accountant")
...
# ─── Accounting domain (Phase 2): Client, Service, Task ───────────────────────
...
class Service(Base):
    ...
    # service_type values: bookkeeping, vat_filing, corporate_tax, payroll,
    # audit, cfo, financial_statements, company_formation, tax_consultation
