...
def upload_image(file_bytes: bytes, public_id: str = None, folder: str = "ecofintec_properties") -> dict:
    try:
...
def upload_file(file_bytes: bytes, file_name: str = None, folder: str = "ecofintec_hr_docs") -> dict:
    try:
