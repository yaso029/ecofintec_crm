...
SERVICE_TYPES = [
    "bookkeeping", "vat_filing", "corporate_tax", "payroll", "audit",
    "cfo", "financial_statements", "company_formation", "tax_consultation",
]
SERVICE_STATUSES = ["active", "paused", "completed", "cancelled"]
RECURRENCES = ["one_time", "monthly", "quarterly", "annual"]

# UAE service catalog with defaults to help the frontend pre-fill the form
SERVICE_CATALOG = [
    {"key": "bookkeeping",          "label": "Bookkeeping",            "default_recurrence": "monthly",   "typical_fee_aed": 1500},
    {"key": "vat_filing",           "label": "VAT Filing",             "default_recurrence": "quarterly", "typical_fee_aed": 1000},
    {"key": "corporate_tax",        "label": "Corporate Tax",          "default_recurrence": "annual",    "typical_fee_aed": 3500},
    {"key": "payroll",              "label": "Payroll",                "default_recurrence": "monthly",   "typical_fee_aed": 800},
    {"key": "audit",                "label": "Audit",                  "default_recurrence": "annual",    "typical_fee_aed": 8000},
    {"key": "cfo",                  "label": "CFO Services",           "default_recurrence": "monthly",   "typical_fee_aed": 5000},
    {"key": "financial_statements", "label": "Financial Statements",   "default_recurrence": "annual",    "typical_fee_aed": 4000},
    {"key": "company_formation",    "label": "Company Formation",      "default_recurrence": "one_time",  "typical_fee_aed": 12000},
    {"key": "tax_consultation",     "label": "Tax Consultation",       "default_recurrence": "one_time",  "typical_fee_aed": 2000},
]
...
def _enforce_type_scope(current_user: User, service_type: Optional[str]):
    """For service-scoped roles (payroll_specialist, tax_consultant), block
