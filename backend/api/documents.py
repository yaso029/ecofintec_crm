...
DOCUMENT_CATEGORIES = [
    "trade_license", "vat_return", "ct_return", "financial_statement",
    "bank_statement", "invoice", "receipt", "contract", "passport_eid",
...
def get_access_log(
    ...
    """Audit trail for a document. Restricted to admin / senior_accountant since it
