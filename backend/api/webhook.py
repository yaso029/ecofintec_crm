...
WEBHOOK_SECRET = os.environ.get("WEBHOOK_SECRET", "ecofintec-webhook-secret-change-me")
META_VERIFY_TOKEN = os.environ.get("META_VERIFY_TOKEN", "ecofintec-meta-leads-2024")
