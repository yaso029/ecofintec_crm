...
export default function ClientDetailPage() {
  ...
  const fields = [
    ...
    ['TRN', client.trn ? <code className="font-mono">{client.trn}</code> : null],
    ['CT Reg #', client.ct_registration_number],
    ['Trade License', client.trade_license_number],
    ['Emirate', client.trade_license_emirate],
    ['Fiscal Year End', client.fiscal_year_end_month
      ? `${new Date(2000, client.fiscal_year_end_month - 1).toLocaleString('default', { month: 'short' })} ${client.fiscal_year_end_day || ''}`
      : null],
  ...
  return (
    <div className="min-h-screen bg-page p-7">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            ...
            <div className="mt-1.5 flex flex-wrap items-center gap-3">
              ...
              {client.esr_applicable && <span className="badge bg-amber-100 text-amber-700">ESR</span>}
            </div>
          </div>
      ...
      <div className="card overflow-hidden">
        {tab === 'services' ? (
          services.length === 0 ? (
            <div className="p-10 text-center text-gray-400">No services yet. Add one (Bookkeeping, VAT Filing, etc.)</div>
          ) : (
          ...
          /* Compliance tab — deterministic UAE tax checklist */
          !checklist ? (
