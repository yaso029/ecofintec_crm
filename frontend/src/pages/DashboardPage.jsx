    ...
    <div>
        ...
        <ChartCard title="Leads by Stage">
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={stageData}>
              ...
              <Tooltip cursor={{ fill: 'rgba(31,122,89,0.06)' }} />
      ...
      {adminData && (
        <div className={`grid gap-5 ${isMobile ? 'grid-cols-1' : 'grid-cols-2'}`}>
          <div className="card p-6">
            <h3 className="mb-4 text-[15px] font-semibold text-[var(--text)]">Accountant Performance</h3>
            {adminData.accountant_performance?.map(a => (
