...
const T = {
  en: {
    welcome: {
      ...
      subtitle: 'Partner with Ecofintec Accounting and earn commissions on every successful deal you refer.',
      start: 'Apply Now',
    },
    form: {
    ...
    agreement: {
      ...
      terms: [
        'I agree to refer clients exclusively to Ecofintec Accounting for the duration of our partnership.',
    ...
    return (
      <div style={{ fontFamily }} className="flex min-h-screen items-center justify-center bg-white px-6 py-10">
        ...
        <div className="w-full max-w-[480px] text-center">
          <img src="/ecofintec-logo.png" alt="Ecofintec Accounting" className="mb-8 h-[120px] w-auto" />
